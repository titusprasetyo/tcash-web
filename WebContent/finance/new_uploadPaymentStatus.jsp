...
try{
	...
	con = DriverManager.getConnection("jdbc:oracle:thin:@10.251.230.214:1521:tcashdb1", "tunai", "tunai123");
	//con = DriverManager.getConnection("jdbc:oracle:thin:@10.2.114.121:1521:OPTUNAI", "tunai", "b0m#RK4du21");
