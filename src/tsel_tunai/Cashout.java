...
public class Cashout {
  ...
  public String[] submit() {
    ...
    try {
      ...
      String sql =
          "select balance from rfid_account where card_id = ? for update ";
      ...
      if (b1 && b2) {
        ...
        sql =
            "update rfid_account set balance=balance-? ,create_time=sysdate where card_id = ?";
        ps = con.prepareStatement(sql);
        ...
        sql = "insert into log_cashout values(?, ?, ?, ?, sysdate, '0')";
        ps = con.prepareStatement(sql);
        ...
        ps.setString(4, String.valueOf(UssdTx.OFFLINE_CASHOUT));
        ...
        ps.setString(5, String.valueOf(UssdTx.OFFLINE_CASHOUT));
        ps.setString(6, "0");
        ...
        ps.setString(10, "");
        ps.setString(11, this.loadingTerminalId);
        ps.executeUpdate();
        ps.close();
  ...
  public String[] submitRollback() {
    ...
    try {
      ...
      if (b1 && b2) {
        ...
        sql = "update log_cashout set status='R', tx_date=sysdate where txid=?";
        ps = con.prepareStatement(sql);
        ps.setString(1, this.txid);
        ps.executeUpdate();
        ps.close();
        ...
        ps.setString(2, this.acc_no);
        ps.setString(3, this.cardid);
        ps.setString(4, String.valueOf(UssdTx.OFFLINE_CASHOUT_ROLLBACK));
        ps.setString(5, "0");
        ...
        ps.setString(3, merchant_acc_no);
        ps.setString(4, this.cardid);
        ps.setString(5, String.valueOf(UssdTx.OFFLINE_CASHOUT_ROLLBACK));
        ps.setString(6, this.amount);
        ps.setString(7, "0");
        ps.setDouble(8, (balance_merchant - Double.parseDouble(this.amount)));
        ps.setString(9, this.loadingTerminalId);
  ...
  public boolean validateTxidRollback() {
    ...
    try {
      con = DbCon.getConnection();
      String sql =
          "select txid from log_cashout where txid= ? and status = '0'";
      PreparedStatement ps = con.prepareStatement(sql);
      ps.setString(1, this.txid);
  ...
  public boolean validateTxid() {
    ...
    try {
      con = DbCon.getConnection();
      String sql =
          "select txid from log_cashout where txid= ?";
      PreparedStatement ps = con.prepareStatement(sql);
      ps.setString(1, this.txid);
